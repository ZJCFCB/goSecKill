...
import (
	...
	"goSecKill/pkg/mysql"
	"goSecKill/user-service/endpoint"
	"goSecKill/user-service/plugins"
	"goSecKill/user-service/service"
	"goSecKill/user-service/transport"
	...
	register "goSecKill/pkg/discover"

	localconfig "goSecKill/user-service/config"
